...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("O valor b est� no �ndice "+indice);
		...
		System.out.println("O array listaString � igual a listaString2? "+igualdade);
		igualdade=Arrays.equals(listaString,listaString3);
		System.out.println("O array listaString � igual a listaString3? "+igualdade);
